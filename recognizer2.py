...
def parse_args():
    ...
    if input_args.seq2seq:
        ...
        text_lines, word_boxes, images_data = prepare_data(input_args.seq2seq[0][0], input_args.seq2seq[0][1], n_image_rnn_steps)
...
def prepare_data(page_file_path, input_words_file_path, n_image_rnn_steps):
    ...
    return text_lines, word_boxes, images_data
